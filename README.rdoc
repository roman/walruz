...
Walruz facilitates the separation between the authorization process on the business logic and, the actions executed after the validation of the authorizations are done. To achieve this, Walruz follows the following terminology:
